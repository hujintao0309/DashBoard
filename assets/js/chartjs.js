    ...
    datasets: [
      {
        ...
        data: [read(day1), read(day2), read(day3), read(day4), read(day5), read(day6), read(day7), read(day8)]
      }
    ]
  };
    ...
    datasets: [
      {
        ...
        pointHighlightFill: "#fff",
        pointHighlightStroke: "#1ABC9C",
        data: [readp(day1), readp(day2), readp(day3), readp(day4), readp(day5), readp(day6), readp(day7), readp(day8)]
      }
    ]
  };
